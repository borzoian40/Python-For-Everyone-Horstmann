...
#And the reason we end with "number + 1" in our range is that because we want the final number of our range to be included as well hence we add one to the index for it to be included as well.
