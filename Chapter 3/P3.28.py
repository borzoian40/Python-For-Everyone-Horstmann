"""
••• P3.28 Roman numbers. Write a program that converts a positive integer into the Roman 
...
b. Asin the decimalsystem, the thousands, hundreds, tens, and ones are expressed separately.
...
VIII 8
IX 9
As you can see, an I preceding a V or X issubtracted from the value, and you 
